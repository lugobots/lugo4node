...
// starter.setInitialPosition(position)
// starter.setMapper(mapper)
starter.run(new myBot_js_1.MyBot(starter.getConfig().getBotTeamSide(), starter.getConfig().getBotNumber(), starter.getInitialPosition(), starter.getMapper()));
// ADVANCED
