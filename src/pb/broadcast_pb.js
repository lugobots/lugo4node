...
goog.exportSymbol('proto.lugo.EventGameOver.BlameStop', null, global);
goog.exportSymbol('proto.lugo.EventGameOver.EndingReason', null, global);
...
goog.exportSymbol('proto.lugo.EventPeriodChanged', null, global);
 ...
 * @constructor
 */
proto.lugo.EventPeriodChanged = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.lugo.EventPeriodChanged, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.lugo.EventPeriodChanged.displayName = 'proto.lugo.EventPeriodChanged';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.lugo.GameEvent.oneofGroups_ = [[2,3,4,5,6,7,8,9]];
...
proto.lugo.GameEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    periodChanged: (f = msg.getPeriodChanged()) && proto.lugo.EventPeriodChanged.toObject(includeInstance, f)
  };
...
proto.lugo.GameEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto.lugo.EventPeriodChanged;
      reader.readMessage(value,proto.lugo.EventPeriodChanged.deserializeBinaryFromReader);
      msg.setPeriodChanged(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.lugo.GameEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPeriodChanged();
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.lugo.EventPeriodChanged.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional EventPeriodChanged period_changed = 9;
 * @return {?proto.lugo.EventPeriodChanged}
 */
proto.lugo.GameEvent.prototype.getPeriodChanged = function() {
  return /** @type{?proto.lugo.EventPeriodChanged} */ (
    jspb.Message.getWrapperField(this, proto.lugo.EventPeriodChanged, 9));
};


/**
 * @param {?proto.lugo.EventPeriodChanged|undefined} value
 * @return {!proto.lugo.GameEvent} returns this
*/
proto.lugo.GameEvent.prototype.setPeriodChanged = function(value) {
  return jspb.Message.setOneofWrapperField(this, 9, proto.lugo.GameEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.lugo.GameEvent} returns this
 */
proto.lugo.GameEvent.prototype.clearPeriodChanged = function() {
  return this.setPeriodChanged(undefined);
};
 ...
 * @return {boolean}
 */
proto.lugo.GameEvent.prototype.hasPeriodChanged = function() {
 ...
 * @return {!Object}
 */
proto.lugo.EventPeriodChanged.prototype.toObject = function(opt_includeInstance) {
  return proto.lugo.EventPeriodChanged.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.lugo.EventPeriodChanged} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.lugo.EventPeriodChanged.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.lugo.EventPeriodChanged}
 */
proto.lugo.EventPeriodChanged.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.lugo.EventPeriodChanged;
  return proto.lugo.EventPeriodChanged.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.lugo.EventPeriodChanged} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.lugo.EventPeriodChanged}
 */
proto.lugo.EventPeriodChanged.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.lugo.EventPeriodChanged.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.lugo.EventPeriodChanged.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.lugo.EventPeriodChanged} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.lugo.EventPeriodChanged.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPeriod();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional GameSnapshot.Period period = 1;
 * @return {!proto.lugo.GameSnapshot.Period}
 */
proto.lugo.EventPeriodChanged.prototype.getPeriod = function() {
  return /** @type {!proto.lugo.GameSnapshot.Period} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.lugo.GameSnapshot.Period} value
 * @return {!proto.lugo.EventPeriodChanged} returns this
 */
proto.lugo.EventPeriodChanged.prototype.setPeriod = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
...
proto.lugo.EventGameOver.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    blame: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.lugo.EventGameOver.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.lugo.EventGameOver.EndingReason} */ (reader.readEnum());
      msg.setReason(value);
      break;
    case 2:
      var value = /** @type {!proto.lugo.EventGameOver.BlameStop} */ (reader.readEnum());
      msg.setBlame(value);
      break;
    default:
      reader.skipField();
 ...
 * @enum {number}
 */
proto.lugo.EventGameOver.EndingReason = {
  TIME_IS_OVER: 0,
  WAITING_EXPIRED: 1,
  NO_ENOUGH_PLAYER: 2,
  EXTERNAL_REQUEST: 3,
 ...
 * @enum {number}
 */
proto.lugo.EventGameOver.BlameStop = {
  NORMAL: 0,
  BOTH_TEAMS: 1,
  HOME_TEAM: 2,
  AWAY_TEAM: 3
...
/**
 * optional EndingReason reason = 1;
 * @return {!proto.lugo.EventGameOver.EndingReason}
 */
proto.lugo.EventGameOver.prototype.getReason = function() {
  return /** @type {!proto.lugo.EventGameOver.EndingReason} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.lugo.EventGameOver.EndingReason} value
 * @return {!proto.lugo.EventGameOver} returns this
 */
proto.lugo.EventGameOver.prototype.setReason = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional BlameStop blame = 2;
 * @return {!proto.lugo.EventGameOver.BlameStop}
 */
proto.lugo.EventGameOver.prototype.getBlame = function() {
  return /** @type {!proto.lugo.EventGameOver.BlameStop} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.lugo.EventGameOver.BlameStop} value
 * @return {!proto.lugo.EventGameOver} returns this
 */
proto.lugo.EventGameOver.prototype.setBlame = function(value) {
  return jspb.Message.setProto3EnumField(this, 2, value);
};
